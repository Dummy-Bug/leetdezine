...
| File | Topic |
|---|---|
| [Fundamentals](01-Fundamentals.md) | SSL termination, URL/header/cookie routing, canary deployments, L7 cost |
| [Request Flow](02-Request-Flow.md) | Instagram profile request — L7 LB flow vs API Gateway flow end to end |
| [API Gateway](03-API-Gateway.md) | Auth, rate limiting, transformation, three-layer architecture, Netflix and Uber examples |
