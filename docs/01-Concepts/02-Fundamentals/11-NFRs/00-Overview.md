...
| File | Topic |
|---|---|
| [NFRs And Design Decisions](01-NFRs-And-Design-Decisions.md) | All 6 NFRs — what each forces, what each costs |
| [Conflicting NFRs](02-Conflicting-NFRs.md) | When two NFRs fight, how to handle it in interviews |
