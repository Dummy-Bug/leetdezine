...
→ See [Leader Election](02-Leader-Election.md) for how Raft picks a leader
→ See [Term Numbers](03-Term-Numbers.md) for how term numbers prevent the ghost leader problem
→ See [Log Replication Failures](05-Log-Replication-Failures.md) for how Raft handles crashes during a write
