...
<div class="sh-hero">
  <div class="sh-hero-eyebrow">Your learning path</div>
  <h1 class="sh-hero-title">Start Here</h1>
  <p class="sh-hero-sub">Pick where you are. Follow the path. Show up to interviews knowing the <em>why</em> behind every decision.</p>
</div>

<div class="sh-grid sh-grid-3">

  <div class="sh-card sh-card-green">
    <div class="sh-card-tag">SDE-1 Target</div>
  ...
  <div class="sh-card sh-card-blue">
    <div class="sh-card-tag">SDE-2 Target</div>
    <div class="sh-card-title">Moving up to mid-level</div>
  ...
  <div class="sh-card sh-card-rose">
    <div class="sh-card-tag">Senior / Staff Target</div>
    <div class="sh-card-title">Targeting senior or staff</div>
...
<div class="sh-grid sh-grid-2">
  ...
  <div class="sh-card sh-card-amber">
    <div class="sh-card-tag">Interview in 7 Days</div>
  ...
  <div class="sh-card sh-card-violet">
    <div class="sh-card-tag">30-Day Deep Mastery</div>
    <div class="sh-card-title">The full roadmap</div>
    <div class="sh-card-desc">30 days to go from basics to confidently handling any system design round.</div>
    <ol class="sh-steps">
      <li><strong>Week 1:</strong> All Concepts — Core, Storage, Caching, Estimation</li>
      <li><strong>Week 2:</strong> Foundation — Unique ID Generator + URL Shortener</li>
      <li><strong>Week 3:</strong> Ascent + Expedition — Notification, Pastebin, Rate Limiter</li>
      <li><strong>Week 4:</strong> Summit + Battleground — KV Store + WhatsApp</li>
    </ol>
  </div>
